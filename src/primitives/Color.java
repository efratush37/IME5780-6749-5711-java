...
public class Color {
        ...
        public final static primitives.Color BLACK = new primitives.Color();
         ...
         */
        public Color(primitives.Color other) {
            _r = other._r;
            _g = other._g;
            _b = other._b;
        }
         ...
         */
        public primitives.Color setColor() {
            _r = 0.0;
            _g = 0.0;
            _b = 0.0;
            return this;
         ...
         * @return the Color object itself for chaining calls
         */
        public primitives.Color setColor(double r, double g, double b) {
            if (r < 0 || g < 0 || b < 0)
                throw new IllegalArgumentException("Negative color component is illegal");
            _r = r;
            _g = g;
         ...
         * @return the Color object itself for chaining calls
         */
        public primitives.Color setColor(primitives.Color other) {
            _r = other._r;
            _g = other._g;
            _b = other._b;
            return this;
         ...
         * @return the Color object itself for chaining calls
         */
        public primitives.Color setColor(java.awt.Color other) {
            _r = other.getRed();
            _g = other.getGreen();
            _b = other.getBlue();
            return this;
        ...
        public primitives.Color add(primitives.Color... colors) {
            ...
            return new primitives.Color(r, g, b);
        }
