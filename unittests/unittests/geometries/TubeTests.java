...
public class TubeTests {
    ...
    /**
     * test method for the find intersection function between a ray and the tube
     */
    @Test
    public void findIntsersections() {
        Ray ray = new Ray(new Point3D(1, 0, 0), new Vector(0, 1, 0));
        Tube tube = new Tube(1d, ray);
        //refactoring to list of geo points and using geo points instead of regular ones
        GeoPoint geoPoint = new GeoPoint(tube, new Point3D(0, 2, 0));
        GeoPoint geoPoint2 = new GeoPoint(tube, new Point3D(2, 2, 0));
        ...
        assertEquals("Ray crosses tube", List.of(geoPoint, geoPoint2), result);
        ...
        assertEquals("Ray's crosses the tube", List.of(geoPoint2), result);
        ...
        result = tube.findIntsersections(new Ray(geoPoint.point, new Vector(1, 0, 0)));
        ...
        assertEquals("Ray's start point the tube and go outside", null,
                tube.findIntsersections(new Ray(geoPoint2.point, new Vector(1, 0, 0))));
    }
}