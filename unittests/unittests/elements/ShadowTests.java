...
public class ShadowTests {
    ...
    public void SphereTriangleMove2() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(
                        new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), new Point3D(-50, 20, 0),
                        new Point3D(-20, 50, 0), new Point3D(-48, 48, 4)));
    ...
    public void SphereTriangleSpot1() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(
                        new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), new Point3D(-70, 40, 0),
